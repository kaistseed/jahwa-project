...
HD_PWD='D:/Jahwa/windows/vivado/pynq_mb/jahwa_daq_system/jahwa_daq_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log jahwa_daq_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source jahwa_daq_system_wrapper.tcl -notrace
