...
HD_PWD='D:/Jahwa/windows/vivado/pynq_mb/jahwa_daq_system/jahwa_daq_system.runs/jahwa_daq_system_dff_en_reset_vector_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jahwa_daq_system_dff_en_reset_vector_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source jahwa_daq_system_dff_en_reset_vector_0_0.tcl
