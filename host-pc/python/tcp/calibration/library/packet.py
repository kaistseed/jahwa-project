...
def decode_packet(packet, **kwargs):
    ...
    ##############################################################################################
        ...
        if sequence == measurement_sequence_dict['spi_read_adc']:
            ...
            # Parse decoded data
            transaction_id = decoded_data[0]
            protocol_id = decoded_data[1]
            length = decoded_data[2]
            unit_id = decoded_data[3]
            sequence = decoded_data[4]
            adc_id = decoded_data[5:13]
            adc_softspan = decoded_data[13:21]
            adc_value = decoded_data[21:29]
            adc_voltage = decoded_data[29:]
        ...
        # I2C Meissner chip ID
            ...
            transaction_id, protocol_id, length, unit_id, sequence, chip_id = struct.unpack(
                '2s 2s 2s c I I',
                packet
            )
