...
if __name__ == '__main__':
    ...
    # response = gpio_client.TurnOffPYNQSDN1IO()
    # # Print response
    ...
    # response = gpio_client.TurnOffPYNQSDN2IO()
    # # Print response
    # print("Operation name: {}".format(response.operation_name))
    # print("Start time: {} ns".format(response.start_time))
    # print("End time: {} ns".format(response.end_time))
    ...
    # response = gpio_client.TurnOffPYNQSDN3IO()
    # # Print response
    # print("Operation name: {}".format(response.operation_name))
    # print("Start time: {} ns".format(response.start_time))
    # print("End time: {} ns".format(response.end_time))
    ...
    # response = gpio_client.TurnOnPYNQSDN1IO()
    # # Print response
    # print("Operation name: {}".format(response.operation_name))
    # print("Start time: {} ns".format(response.start_time))
    # print("End time: {} ns".format(response.end_time))
    ...
    # response = gpio_client.TurnOnPYNQSDN2IO()
    # # Print response
    # print("Operation name: {}".format(response.operation_name))
    # print("Start time: {} ns".format(response.start_time))
    # print("End time: {} ns".format(response.end_time))
    ...
    # response = gpio_client.TurnOnPYNQSDN3IO()
    # # Print response
    # print("Operation name: {}".format(response.operation_name))
    # print("Start time: {} ns".format(response.start_time))
    # print("End time: {} ns".format(response.end_time))
    ...
    response = spi_client.ConfigureDACChannel0()
    # Print response
    print("Operation name: {}".format(response.operation_name))
    print("Start time: {} ns".format(response.start_time))
    print("End time: {} ns".format(response.end_time))
    ...
    response = spi_client.ConfigureDACChannel1()
    # Print response
    print("Operation name: {}".format(response.operation_name))
    print("Start time: {} ns".format(response.start_time))
    print("End time: {} ns".format(response.end_time))
    ...
    response = spi_client.ConfigureDACChannel2()
    # Print response
    print("Operation name: {}".format(response.operation_name))
    print("Start time: {} ns".format(response.start_time))
    print("End time: {} ns".format(response.end_time))
    ...
    # Test Reset Meissner
    response = meissner_client.TestI2CConnection()
    # Print response
    print("Operation name: {}".format(response.operation_name))
    print("Start time: {} ns".format(response.start_time))
    print("End time: {} ns".format(response.end_time))
